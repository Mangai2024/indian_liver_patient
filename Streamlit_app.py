...
if nav == "Parkinson's Disease":
    ...
    try:
        parkinson_model = pickle.load(open(r'RFCparkinson.pkl', 'rb'))
    ...
    try:
        liver_model = pickle.load(open('https://github.com/Mangai2024/Multiple_Disease_Prediction/blob/main/https://github.com/Mangai2024/Multiple_Disease_Prediction/blob/main/ADABoostliver.pkl','rb'))
    except FileNotFoundError:
        st.error("Model file not found. Please check the file path.")
        st.stop()    
